...
describe Grover::FerrumProcessor do
    ...
    context 'when converting to PDF' do
      ...
      context 'when passing through options to Grover' do
        ...
        context 'when passing through cookies option' do
          ...
          xit { expect(pdf_text_content).to include 'Request contained 2 cookies' }
          xit { expect(pdf_text_content).to include '1. grover-test nom nom nom' }
          xit { expect(pdf_text_content).to include '2. escaped &==' }
        end
        ...
        context 'when passing through extra HTTP headers' do
          ...
          xit { expect(pdf_text_content).to match(/Request contained (15|16) headers/) }
          xit { expect(pdf_text_content).to include '1. host cookie-renderer.herokuapp.com' }
          xit { expect(pdf_text_content).to include '5. grover-test yes it is' }
        end
        ...
        context 'when overloading the user agent' do
          ...
          xit { expect(pdf_text_content).to match(/Request contained (14|15) headers/) }
          xit { expect(pdf_text_content).to include '1. host cookie-renderer.herokuapp.com' }
          xit { expect(pdf_text_content).to include 'user-agent Grover user agent' }
        end
      end
